...
type linearColorStop2 = [ | #LinearColorStop2(col, length_percentage) ];
type linearColorStop3 = [ | #LinearColorStop3(col, length_percentage, length_percentage) ];
...
type image = [
  | imageSrc
  | gradient
  | #Image(option<imageTags>, option<col>,  [ | imageSrc | col ])
];
