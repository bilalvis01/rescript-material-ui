...
function make(declaration) {
  ...
  if (variant !== "Declaration") {
    ...
    } else if (variant === "BorderTopWidth") {
      return [
              "borderTopWidth",
              declaration.VAL
            ];
    } else if (variant === "BorderRight") {
      return [
              "borderRight",
              declaration.VAL
            ];
    } else if (variant === "BackgroundAttachment") {
      return [
    ...
    } else if (variant === "PaddingRight") {
      return [
              "paddingRight",
              declaration.VAL
            ];
    } else if (variant === "BorderBottomColor") {
      return [
              "borderBottomColor",
              declaration.VAL
            ];
    } else if (variant === "BorderBottomWidth") {
      return [
              "borderBottomWidth",
              declaration.VAL
            ];
    } else if (variant === "PaddingLeft") {
      return [
              "paddingLeft",
              declaration.VAL
            ];
    } else if (variant === "BackgroundColor") {
      return [
              "backgroundColor",
              declaration.VAL
            ];
    ...
    } else if (variant === "BorderStyle") {
      return [
              "border",
              declaration.VAL
            ];
    } else if (variant === "BorderLeft") {
      return [
              "borderLeft",
              declaration.VAL
            ];
    } else if (variant === "BorderRightColor") {
      return [
              "borderRightColor",
              declaration.VAL
            ];
    } else if (variant === "BorderRightWidth") {
      return [
              "borderRightWidth",
              declaration.VAL
            ];
    } else if (variant === "MarginLeft") {
      return [
              "marginLeft",
              declaration.VAL
            ];
    } else if (variant === "BorderTopStyle") {
      return [
              "borderTopStyle",
              declaration.VAL
            ];
    } else if (variant === "MarginBottom") {
      return [
              "marginBottom",
              declaration.VAL
            ];
