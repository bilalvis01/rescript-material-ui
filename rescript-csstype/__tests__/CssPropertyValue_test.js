...
test("background", (function () {
        ...
        expect(CssPropertyValue$Ress.background(undefined, undefined, undefined, "repeatY", undefined, undefined, undefined, CssValueHelper$Ress.url("test.jpg"))).toBe("url(\"test.jpg\") repeat-y");
...
test("backgroundStyle", (function () {
        expect(CssPropertyValue$Ress.backgroundStyle("repeatX")).toBe("repeat-x");
        expect(CssPropertyValue$Ress.backgroundStyle2("repeatX", "repeat__repeat")).toBe("repeat-x, repeat repeat");
        expect(CssPropertyValue$Ress.backgroundStyle3("repeatX", "repeat__repeat", "noRepeat")).toBe("repeat-x, repeat repeat, no-repeat");
        expect(CssPropertyValue$Ress.backgroundStyle4("repeatX", "repeat__repeat", "noRepeat", "space")).toBe("repeat-x, repeat repeat, no-repeat, space");
