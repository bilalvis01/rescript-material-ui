...
function borderColor2(v1, v2) {
  return CssString$Css.borderColor(v1) + " " + CssString$Css.borderColor(v2);
}

function borderColor3(v1, v2, v3) {
  return CssString$Css.borderColor(v1) + " " + CssString$Css.borderColor(v2) + " " + CssString$Css.borderColor(v3);
}

function borderColor4(v1, v2, v3, v4) {
  return CssString$Css.borderColor(v1) + " " + CssString$Css.borderColor(v2) + " " + CssString$Css.borderColor(v3) + " " + CssString$Css.borderColor(v4);
}
