...
external makeProps: (
  ...
  ~count: int=?,
  ~labelDisplayRows: labelDisplayRowsParam => string=?,
  ~labelRowsPerPage: React.element=?,
  ~nextIconButtonProps: IconButton.props=?,
  ~nextIconButtonText: string=?,
  ~onChangePage: ReactEvent.Form.t => unit,
  ...
  ~scope: string=?,
  ~size: TableCell.size=?,
  ~sortDirection: TableCell.SortDirection.t=?,
  ~variant: TableCell.variant=?,
