...
external makeProps: (
  ...
  // Fade props
  ~disableStringModeCompat: bool=?,
  ~\"in": bool=?,
  ~timeout: Transition.Timeout.t=?,
  // Transition props
  ~mountOnEnter: Transition.mountOnEnter=?,
  ~unmountOnExit: Transition.appear=?,
  ~appear: Transition.appear=?,
  ~enter: Transition.enter=?,
  ~addEndListener: Transition.addEndListener=?,
  ~onEnter: Transition.onEnter=?,
  ~onEntering: Transition.onEntering=?,
  ~onEntered: Transition.onEntered=?,
  ~onExit: Transition.onExit,
  ~onExiting: Transition.onExiting,
...
@module("@material-ui/core/Backdrop")
