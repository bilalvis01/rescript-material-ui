...
external makeProps: (
  ...
  ~defaultValue: 'value=?,
  ~displayEmpty: bool=?,
  ~\"IconComponent": React.component<'iconProps>=?,
  ~id: string=?,
  ~input: React.component<'htmlInputElement>=?,
  ...
  ~onClose: ReactEvent.synthetic<'closeEvent>=?,
  ~onOpen: ReactEvent.synthetic<'openEvent>=?,
  ~\"open": bool=?,
  ~renderValue: 'value => React.element=?,
  ~\"SelectDisplayProps": ReactDOM.domProps=?,
  ~value: 'value=?,
  ~variant: variant=?,
...
@module("@material-ui/core/Select")
