...
external makeProps: (
  ...
  ~onClose: (ReactEvent.synthetic<'onCloseEventSource>, [ | #backdropClick | #escapeKeyDown | #tabKeyDown ]) => unit=?,
  ...
  ~\"open": bool,
  ~\"PopoverClasses": Popover.Classes.t=?,
  ~transitionDuration: TransitionDuration.t=?,
  ~variant: variant=?,
  // Popover props
  ~action: ReactDOM.domRef=?,
  ~anchorOrigin: Popover.AnchorOrigin.t=?,
  ~anchorPosition: Popover.AnchorPosition.t=?,
  ~anchorReference: Popover.anchorReference=?,
  ~container: unit => React.element=?,
  ~elevation: int=?,
  ~getContentAnchorEl: Dom.element => Dom.element=?,
  ~marginThreshold: int=?,
  ~\"PaperProps": Paper.props=?,
  ~transformOrigin: Popover.TransformOrigin.t=?,
  ...
  ~hideBackdrop: bool=?,
  ~keepMounted: bool=?,
  ~onBackdroupClick: ReactEvent.Mouse.t => unit=?,
