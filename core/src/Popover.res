...
module AnchorOrigin = {
  ...
  external numberToHorizontal: float => horizontal = "%identity";

  external numberToVertical: float => vertical = "%identity";
...
external makeProps: (
  ...
  ~elevation: int=?,
  ~getContentAnchorEl: Dom.element => Dom.element=?,
  ~marginThreshold: int=?,
  ~onClose: (ReactEvent.synthetic<'onCloseEventSource>, [ | #backdropClick | #escapeKeyDown ]) => unit=?,
  ...
  ~transformOrgin: TransformOrigin.t=?,
  ~\"TransitionComponent": React.component<'transitionProps>=?,
  ~transitionDuration: TransitionDuration.t=?,
  ~\"TransitionProps": 'transitionProps=?,
  // Modal component
  ~\"BackdropComponent": React.component<'backdropProps>=?,
...
@module("@material-ui/core/Popover")
